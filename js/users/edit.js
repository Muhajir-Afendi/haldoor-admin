// Page Title
$('#page-title').text('Editing User - Haldoor')
...
$('#users-form').on('submit', function(e) {
  ...
  var id   = document.getElementById("editing_id").value
  ...
  if (password !== confirm_password) {
    ...
    $.ajax({
      url:"/api/users.php",
      method:"POST",
      data: {action: "edit" , editing_id: id, name: name, email: email, password: password,  confirm_password: confirm_password },
      beforeSend: function(){
          $("#overlay").fadeIn(300);
      },
