// Page Title
$('#page-title').text('Editing Gradution - Haldoor')

// Active Page
$('#graduation-nav').addClass('selected')

$('#graduation-nav .has-arrow, #new-graduation-nav').addClass('active')

$('#graduation-nav .base-level-line').addClass('in')


$('#graduations-form').on('submit', function(e) {
