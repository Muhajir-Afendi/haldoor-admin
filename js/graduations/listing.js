// Page Title
$('#page-title').text('Listing of Graduations - Haldoor')

// Active Page
$('#graduations-nav').addClass('selected')

$('#graduations-nav .has-arrow, #list-graduation-nav').addClass('active')

$('#graduations-nav .base-level-line').addClass('in')

var fetch_container = document.getElementById('graduations-table')
