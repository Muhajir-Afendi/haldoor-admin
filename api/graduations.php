<?php
    ...
    $upload_directory = '../uploads/graduations/'; 
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if(isset($_POST['action']) && $_POST['action'] === "fetch") {
                ...
                if (gettype($validation) === "array") {
                    ...
                    // Modals
                    $fetch_modal = "SELECT `id`, `title`, `body`, `image` FROM `graduations` LIMIT ?,$singlePageRows";
                    $totalRows_modal = "SELECT COUNT(*) AS total_rows FROM graduations";
                    ...
                    if ($stmt->num_rows === 0) {
                        $response['error'] = true;
                        $response['message'] = 'There are no registered graduations !!';
                    }
                    else
                    {
            ...
            // Search
                ...
                if (gettype($validation) === "array") {
                    ...
                    // Modal
                    $search_modal = "SELECT `id`, `title`, `body`, `image` FROM `graduations` WHERE `title` LIKE ? OR  `body` LIKE ? LIMIT $singlePageRows";
            ...
            // Delete
                ...
                if (gettype($validation) === "array") {                
                    ...
                    $DELETE = "DELETE FROM `graduations` WHERE `id` = ?";
