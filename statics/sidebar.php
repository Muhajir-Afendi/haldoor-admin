    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        <nav class="sidebar-nav">
            ...
            <ul id="sidebarnav">
                ...
                <!-- Users -->
                <li class="sidebar-item" id="users-nav"> 

                    <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                        <i data-feather="file-text" class="feather-icon"></i><span class="hide-menu">Users</span>
                    </a>
                ...
                <!-- Graduation -->
                <li class="sidebar-item" id="graduation-nav"> 

                    <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                        <i data-feather="bar-chart" class="feather-icon"></i>
                        <span class="hide-menu">Graduation</span>
                    </a>
                ...
                <!-- Achievements -->
                <li class="sidebar-item" id="achievements-nav"> 
                ...
                <li class="sidebar-item"> 
                    ...
                    <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                        ...
                        <span class="hide-menu">Keynotes</span>
                    </a>
