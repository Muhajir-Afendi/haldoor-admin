...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
                    ...
                    $fetch_modal = "SELECT `id`, `title`, `body`, `image` FROM `achievements` WHERE `id` = ?";
                    ...
                    if ($stmt->num_rows === 0) {
                        echo "<script type='text/javascript'> window.location.replace('/haldoor-admin/achievements/listing.php'); </script>";
                        exit();
                    }
                    else
                    {
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">New Achievements</h4>
                        
                        <form action="achievements/create" method="POST" id="achievements-form">
    ...
    <!--Custom JavaScript -->
    <script src="../js/achievements/edit.js"></script>
