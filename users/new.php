                            ...
                            <div class="row" style="margin-top: 3rem">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="^[A-Za-z ]{5,191}$" class="form-control" name="user_name" id="user_name" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="user_email" id="user_email" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" min="8" max="16" class="form-control" name="user_pwd" id="pwd" required="required">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" min="8" max="16" class="form-control" name="user_cpwd" id="cpwd" required="required">
